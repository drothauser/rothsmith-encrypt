 ...
 */
public enum TDesTextEncryptor implements TextEncryptor {
	 ...
	 */
	private static final Logger LOGGER = LoggerFactory.getLogger(TDesTextEncryptor.class);
